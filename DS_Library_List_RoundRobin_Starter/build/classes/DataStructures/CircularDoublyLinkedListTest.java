...
public class CircularDoublyLinkedListTest {
    ...
    public void testAddLast() {
        ...
        try {
            assertEquals(circle.getNode(2).getElement().intValue(), 30);
            System.out.println("completed assertion of value 30");
            assertEquals(circle.getNode(2).getNext().getElement().intValue(), 
                    10);
        } catch (Exception ex) {             
    ...
    public void testRemove3() throws Exception {
        ...
        circle.addLast(10);
        circle.addLast(20);
        assertEquals((circle.getNode(0)).getPrev().getElement().intValue(), 
                20);
        assertEquals(circle.size(), 2);
        circle.remove(new Integer(20));
        assertEquals((circle.getNode(0)).getPrev().getElement().intValue(),
